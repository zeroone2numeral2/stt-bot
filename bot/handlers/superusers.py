...
sttbot.add_handler(CommandHandler(["superuser", "su"], on_superuser_command_group, filters=Filters.chat_type.groups & CFilters.from_admin), group=-1)
sttbot.add_handler(CommandHandler(["superuser", "su"], on_superuser_command_private, filters=Filters.chat_type.private & CFilters.from_admin), group=-1)
sttbot.add_handler(CommandHandler(["superusers", "sus"], on_list_superusers_command, filters=Filters.chat_type.private & CFilters.from_admin), group=-1)
sttbot.add_handler(MessageHandler(Filters.chat_type.private & Filters.forwarded & CFilters.from_admin, on_forwarded_message), group=-1)
sttbot.add_handler(CommandHandler("cleandl", on_cleandl_command, filters=Filters.chat_type.private & CFilters.from_admin), group=-1)
sttbot.add_handler(CommandHandler("r", on_r_command, filters=Filters.reply & CFilters.from_admin), group=-1)
sttbot.add_handler(CommandHandler(["parse", "p"], on_parse_command, filters=Filters.reply & CFilters.from_admin), group=-1)
sttbot.add_handler(CommandHandler(["testignore", "ti"], on_testignore_command, filters=Filters.chat_type.groups & Filters.reply & CFilters.from_admin), group=-1)
sttbot.add_handler(CommandHandler(["mediainfo", "mi"], on_mediainfo_command, filters=Filters.reply & CFilters.from_admin), group=-1)
